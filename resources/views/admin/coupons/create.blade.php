...
<div class="mb-6 flex justify-between items-center">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-3xl font-bold font-space-mono text-gray-800">Add Coupon</h1>
    </div>
</div>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" min="1" step="1" name="usage_limit" id="usage_limit" value="{{ old('usage_limit') }}" 
                           class="w-full bg-white/50 border border-gray-200 rounded-sm px-4 py-3 focus:outline-none focus:border-black transition-colors font-instrument"
                           placeholder="e.g. 100">
                    @error('usage_limit')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
