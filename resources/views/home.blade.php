...
<body class="font-instrument antialiased text-gray-900 bg-hero-gradient overflow-x-hidden">
    ...
    <main class="relative w-full h-[100vh] min-h-[700px] flex items-center justify-center z-40">
        ...
        <!-- Bottom Hero HUD -->
        <div
            class="absolute bottom-[20%] md:bottom-[10%] lg:bottom-[22%] left-6 right-6 lg:left-[8%] lg:right-[7%] z-20 flex flex-col lg:flex-row items-center lg:items-end justify-between gap-5 lg:gap-0">
            <!-- Description (Left) -->
        ...
        <div class="absolute bottom-16 md:-bottom-4 lg:bottom-8 left-6 md:left-20 z-20 flex items-center">
            <!-- Back/Chevron Circle -->
