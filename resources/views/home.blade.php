...
<body class="font-instrument antialiased text-gray-900 bg-hero-gradient overflow-x-hidden">
    ...
    <!-- About Section -->
    <section class="relative w-full pt-24 pb-0 md:pt-16 md:pb-16 lg:pt-24 lg:pb-36 bg-transparent overflow-hidden">
    ...
    <!-- Reviews Section -->
    <section class="relative w-full py-16 lg:py-32 overflow-hidden -mt-[5.4rem] lg:-mt-[60px]"
